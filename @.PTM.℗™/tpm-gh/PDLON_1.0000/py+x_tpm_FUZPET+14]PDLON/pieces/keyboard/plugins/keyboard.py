...
# Paths relative to this plugin's location (pieces/keyboard/plugins/)
HISTORY_FILE_PATH = os.path.abspath(os.path.join(script_dir, '../history.txt'))
MASTER_LEDGER_PATH = os.path.abspath(os.path.join(script_dir, '../../master_ledger/master_ledger.txt'))
