...
PIECES = [
    'pieces/fuzzpet/plugins/fuzzpet.py',
    'pieces/world/plugins/game_logic.py',
    'pieces/master_ledger/plugins/master_ledger_monitor.py',
    'pieces/display/plugins/renderer.py',
    'pieces/display/plugins/gl_renderer.py',  # GL renderer with window display
