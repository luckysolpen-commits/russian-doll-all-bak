...
MASTER_LEDGER_PATH = os.path.join(os.path.dirname(__file__), '../pieces/master_ledger/ledger.txt')
MONITOR_LOG_PATH = os.path.join(os.path.dirname(__file__), '../pieces/master_ledger/monitor_log.txt')
