...
gcc -o +x/gl_renderer.+x plugins/gl_renderer.c -lGL -lglut `pkg-config --cflags --libs freetype2`
...
gcc -o +x/increment_time.+x plugins/increment_time.c

echo "Compiling increment_turn..."
gcc -o +x/increment_turn.+x plugins/increment_turn.c

echo "Compiling end_turn..."
gcc -o +x/end_turn.+x plugins/end_turn.c
