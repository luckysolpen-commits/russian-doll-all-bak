...
void execute_option(DesktopWindow* win, int index) {
    ...
    /* Standard Terminal Contexts */
        ...
        if (index == 0) {
            ...
            strcpy(win->menu_options[2], "aow-2d");
            strcpy(win->menu_options[3], "piececraft-3d");
            strcpy(win->menu_options[4], "GLTPM Apps ->");
            strcpy(win->menu_options[5], "3D Cube Demo");
            strcpy(win->menu_options[6], "back");
        ...
        if (index == 0) {
            ...
            add_history(win, "Launching aow-2d...");
            create_mirrored_window("aow-2d", "AOW-2D");
        } else if (index == 3) {
            add_history(win, "Launching piececraft-3d...");
            create_mirrored_window("piececraft-3d", "Piececraft-3D");
        } else if (index == 4) {
