...
# This prevents double-rendering and input conflicts

# ═══════════════════════════════════════════════════════════════
# ⚠ CRITICAL: KILL REGEX — DO NOT CHANGE WITHOUT TESTING
# ═══════════════════════════════════════════════════════════════
# In ERE (pkill -f), \+ means "one or more +" and \. means "one or more dots".
# The OLD regex (pieces/.*/\+x/.*\.+x) matched ZERO processes.
# Result: old processes accumulated → double-movement, stale keys, crashes.
# FIX: Use character classes [.] and [+] for literal matching.
