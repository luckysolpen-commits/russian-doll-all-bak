...
void process_key(int key) {
    ...
    else if (key == '2' || key == J_B1) { // Feed Pet (Aligned to UI Index 2 or J-B1)
    ...
    else if (key == '3' || key == J_B2) { // Play (Aligned to UI Index 3 or J-B2)
    ...
    else if (key == '4' || key == J_B3) { // Sleep (Aligned to UI Index 4 or J-B3)
