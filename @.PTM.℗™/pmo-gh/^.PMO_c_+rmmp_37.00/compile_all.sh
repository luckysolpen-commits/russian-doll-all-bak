...
gcc $CFLAGS_MACOS -o pieces/apps/gl_os/plugins/+x/gl_os_renderer.+x pieces/apps/gl_os/plugins/gl_os_renderer.c $GL_FLAGS
...
echo "Compiling fuzzpet_v2_module..."
mkdir -p projects/fuzzpet_v2/manager/+x
gcc -o projects/fuzzpet_v2/manager/+x/fuzzpet_v2_module.+x projects/fuzzpet_v2/manager/fuzzpet_v2_module.c
