...
// Responsibility: Auto-mode ticking, updates state.txt via piece_manager
// NOTE: Does NOT hit frame marker - clock ticks are silent. Apps poll clock state as needed.
...
int main() {
    ...
    while (1) {
        ...
        if (strcmp(mode, "auto") == 0) {
            ...
            // Clock daemon is SILENT - does not hit frame marker
            // Apps that need clock updates should poll clock_daemon state
        }
