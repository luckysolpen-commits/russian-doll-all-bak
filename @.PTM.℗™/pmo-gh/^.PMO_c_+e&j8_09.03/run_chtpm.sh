...
# Now using Spatial Scanning (SMF) instead of registry.txt
...
# The piece_manager resolves pet_01, pet_02, selector via location_kvp
...
# 8. [DEPRECATED] OS Process Monitor now integrated into components
# mkdir -p pieces/os/procs
