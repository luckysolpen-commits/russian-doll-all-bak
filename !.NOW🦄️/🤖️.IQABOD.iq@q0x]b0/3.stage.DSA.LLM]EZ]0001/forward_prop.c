...
// --- RoPE Implementation ---
// Function to compute rotary positional embedding
...
// Initialize input vector - using RoPE-transformed pe value from vocab
...
for(int j=0;j<EMBEDDING_DIM;j++){
    ...
    for(int j=0;j<vs;j++){
        // Use the RoPE-enhanced pe value from vocabulary
