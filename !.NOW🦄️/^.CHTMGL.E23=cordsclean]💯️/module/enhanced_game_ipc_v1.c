...
int main() {
    ...
    // Send initial state immediately on startup
    // 1. Send player shape (blue moving square with variable alpha) with missingno.png texture
    printf("SHAPE;SQUARE;player;%.2f;%.2f;%.2f;20.0;20.0;5.0;0.0;0.0;1.0;%.2f;0;0;0;1;1;1;texture_src=missingno.png\n", 
           player_x, player_y, player_z, player_alpha);
    
    // 2. Send enemy shape (red square with variable alpha) with missingno.png texture
    printf("SHAPE;RECT;enemy;%.2f;%.2f;%.2f;15.0;15.0;5.0;1.0;0.0;0.0;%.2f;0;0;0;1;1;1;texture_src=missingno.png\n", 
           enemy_x, enemy_y, enemy_z, enemy_alpha);
    
    // 3. Send second enemy shape (orange square - static alpha) with missingno.png texture
    printf("SHAPE;SQUARE;enemy2;%.2f;%.2f;%.2f;12.0;12.0;5.0;1.0;0.5;0.0;1.0;0;0;0;1;1;1;texture_src=missingno.png\n", 
           enemy2_x, enemy2_y, enemy2_z);
    
    // 4. Send powerup shape (green circle with pulsing alpha) with missingno.png texture
    printf("SHAPE;CIRCLE;powerup;%.2f;%.2f;%.2f;8.0;8.0;5.0;0.0;1.0;0.0;%.2f;0;0;0;1;1;1;texture_src=missingno.png\n", 
    ...
    printf("SHAPE;SQUARE;bg_element;%.2f;%.2f;%.2f;%.2f;%.2f;5.0;0.5;0.0;0.5;0.7;0;0;0;1;1;1;texture_src=missingno.png\n", 
    ...
    printf("SHAPE;TRIANGLE;rotating_shape;%.2f;%.2f;%.2f;15.0;15.0;5.0;1.0;1.0;0.0;%.2f;0;0;0;1;1;1;texture_src=missingno.png\n", 
