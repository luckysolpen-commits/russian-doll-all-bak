// craft.js - 3D Crafting Game for JS CLI - Multi-Window Compatible - Extends AppBase

class CraftApp extends AppBase {
    ...
    getDefaultWidth() {
        return 900;  // Craft app specific width
    }
    
    getDefaultHeight() {
        return 600;  // Craft app specific height
    }
            ...
            craftWindow.innerHTML = `
                <div class="title-bar">
                    ...
                    <div class="window-buttons">
                        <div class="window-toolbar-btn">
                            <button onclick="window.appInstances['${this.instanceId}'].closeGUI()">Exit to Terminal</button>
                        </div>
                ...
                <div class="terminal-content">
                    <div id="${this.instanceId}-game-container" class="grid-container">
                        <div id="${this.instanceId}-header" class="grid-header">
                        ...
                        <div id="${this.instanceId}-sidebar" class="grid-sidebar">
                        ...
                        <div id="${this.instanceId}-main" class="grid-main">
                            <div id="${this.instanceId}-gameContainer" style="position: relative; width: 100%; height: 100%;">
                                <div id="${this.instanceId}-canvasContainer" class="canvas-container"></div>
