...
class GridWidget3D(QOpenGLWidget):
    ...
    def init_entities(self):
        ...
        for row in range(2):
            for col in range(self.grid_size):
                # Use format: f"{z},{x}" to match selector position comparison logic from hybrid viewer
