...
class Ui_MainWindow(QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.search_label = QLabel("Search:", self.playlist_group)
        self.search_input = QLineEdit(self.playlist_group)
        ...
        # Shuffle button
        self.shuffle_button = QPushButton("Shuffle", self.playlist_group)
