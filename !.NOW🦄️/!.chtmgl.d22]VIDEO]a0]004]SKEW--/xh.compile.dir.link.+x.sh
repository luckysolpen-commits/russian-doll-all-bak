...
LIBRARIES="-pthread -lm -lssl -lcrypto -lGL -lGLU -lglut -lGLEW -lfreetype -lavcodec -lavformat -lavutil -lswscale -lswresample -lpulse-simple -lpulse -lX11 -I/usr/include/freetype2 -I/usr/include/libpng12 -L/usr/local/lib -lOpenCL"
