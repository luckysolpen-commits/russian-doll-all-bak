...
int keep_temp = 0;   // 0 = cleanup (default), 1 = keep temp files
...
int main(int argc, char* argv[]) {
    if (argc < 2) {
        ...
        fprintf(stderr, "   --keep-temp : Keep temporary files and directory for debugging\n");
        return 1;
    }
