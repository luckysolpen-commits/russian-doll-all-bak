...
SCENE_DIR = "./angler-screenplay"
OUTPUT_DIR = "./angler-screenplay/audio-output-50"
...
VOICE_MAP = {
    ...
    "ARMSTRONG": "en-US-EricNeural",
    "GENERAL ARMSTRONG": "en-US-EricNeural",
    "DELEGATE CHEN": "ja-JP-KeitaNeural",
    "SCIENTIST DR. ELARA VANCE": "en-US-AshleyNeural",
    "DR. ELARA VANCE": "en-US-AshleyNeural",
    ...
    #ffu
    "MEI-LING": "zh-HK-HiuGaaiNeural",
    "LING-LI": "zh-HK-WanLungNeural",
    "XI-XI": "zh-TW-HsiaoChenNeural",
    "ARIANNA": "en-US-AriaNeural",
    "RED WAX OFFICER 1": "ar-EG-ShakirNeural",
    "CAPTAIN JIN": "pl-PL-MarekNeural",
    "KEEPER": "zh-CN-YunyangNeural",
    "RED WAX OFFICER 2": "hi-IN-MadhurNeural",
    "RIVER GODDESS": "ja-JP-NanamiNeural",
    "LYSANDER": "en-US-SteffanNeural",
    "EMPEROR": "zh-CN-YunyangNeural",
    #tear
    "TORREN": "en-IE-ConnorNeural",
    "LORCAN": "fr-CA-JeanNeural",
    "KAI": "en-AU-WilliamNeural",
    "RHYS": "it-IT-GiuseppeMultilingualNeural",
    "V.O. ELARA": "fr-CH-ArianeNeural",
