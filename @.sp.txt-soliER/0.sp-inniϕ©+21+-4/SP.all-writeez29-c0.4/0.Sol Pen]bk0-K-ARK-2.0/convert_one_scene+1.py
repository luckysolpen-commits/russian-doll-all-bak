...
VOICE_MAP = {
    ...
    "SPIKE": "WilliamMultilingualNeural",
    "NEW-KOREA GENERAL": "ko-KR-HyunsuMultilingualNeural",
    "SOO-JIN": "zh-HK-HiuMaanNeural",
    "JI-HYUN": "zh-TW-HsiaoYuNeural",
    "VANCE": "en-ZA-LukeNeural",
}
