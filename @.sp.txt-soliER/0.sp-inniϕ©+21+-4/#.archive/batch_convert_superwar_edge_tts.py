#!/usr/bin/env python3
"""
Batch convert Superwar chapters to audio using edge-tts (single voice).
...
BOOK_DIR = "SP.all-writeez28-a1/5.SUPERWAR.ikrs]FULwc]bk0/book_template.scp"
VOICE = "en-US-JennyNeural"
OUTPUT_PREFIX = "sw.chapter"
