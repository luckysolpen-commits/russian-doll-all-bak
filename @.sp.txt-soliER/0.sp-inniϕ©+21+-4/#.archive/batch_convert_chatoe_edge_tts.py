#!/usr/bin/env python3
"""
Batch convert Chatoe BnB 13 chapters to audio using edge-tts (single voice).
...
BOOK_DIR = "SP.all-writeez28-a1/333.chatoe.bnb.13]a0]FULL"
VOICE = "en-US-JennyNeural"
OUTPUT_PREFIX = "chatoe.chapter"
