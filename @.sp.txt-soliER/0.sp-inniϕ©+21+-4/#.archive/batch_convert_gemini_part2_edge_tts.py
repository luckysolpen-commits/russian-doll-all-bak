#!/usr/bin/env python3
"""
Batch convert Geminii Part 2 chapters to audio using edge-tts (single voice).
...
BOOK_DIR = "SP.all-writeez28-a1/1.ii.geminii]2part]a0/1.GEMANDI.part2/book_partii.gemini"
VOICE = "en-US-JennyNeural"
OUTPUT_PREFIX = "gem2.chapter"
OUTPUT_SUFFIX = "-v1.0.mp3"

async def convert_chapter(ch_dir, output_path, ch_num, total):
    """Combine all page_N.txt files and convert using edge-tts."""
    # Find all page files, sorted numerically
    page_files = sorted(
