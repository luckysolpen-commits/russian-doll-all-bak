#!/usr/bin/env python3
"""
Batch convert Metal Sun chapters to audio using edge-tts (single voice).
...
BOOK_DIR = "SP.all-writeez28-a1/9.METAL SUN[METAL]wcsm+wtf]a1/ms_book]a0"
VOICE = "en-US-JennyNeural"
OUTPUT_PREFIX = "msun.chapter"
