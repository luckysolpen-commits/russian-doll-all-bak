#!/usr/bin/env python3
"""
Batch convert Centroid chapters to audio using edge-tts (single voice).
...
BOOK_DIR = "SP.all-writeez28-a1/12.centroid.u.ϕ]2xvsp]big]b1/cent-book.bigword]a0"
VOICE = "en-US-JennyNeural"
OUTPUT_PREFIX = "cent.chapter"
