#!/usr/bin/env python3
"""
Batch convert Digi_Sol Suicider chapters to audio using edge-tts (single voice).
...
BOOK_DIR = "SP.all-writeez28-a1/8.Digi_Sol.Suicider]BIG]b1/8.DSS.book_]full-gemini]a0"
VOICE = "en-US-JennyNeural"
OUTPUT_PREFIX = "dss.chapter"
