#!/usr/bin/env python3
"""
Batch convert XO Files chapters to audio using edge-tts (single voice).
...
BOOK_DIR = "SP.all-writeez28-a1/10.xo.files]wc.smol]a0/book_template.scp"
VOICE = "en-US-JennyNeural"
OUTPUT_PREFIX = "xo.chapter"
