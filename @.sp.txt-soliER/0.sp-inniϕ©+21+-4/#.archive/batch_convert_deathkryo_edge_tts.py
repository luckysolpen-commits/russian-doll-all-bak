#!/usr/bin/env python3
"""
Batch convert Death-Kryo! chapters to audio using edge-tts (single voice).
...
BOOK_DIR = "SP.all-writeez28-a1/3.DEATH-KRYO!]big]b2/book_template.scp"
VOICE = "en-US-JennyNeural"
OUTPUT_PREFIX = "dk.chapter"
