#!/usr/bin/env python3
"""
Batch convert Red Rock & Roll chapters to audio using edge-tts (single voice).
...
BOOK_DIR = "SP.all-writeez28-a1/2.RedRock.AndROLL]ING]mid]a1/book_RR]BIG"
VOICE = "en-US-JennyNeural"
OUTPUT_PREFIX = "rr.chapter"
