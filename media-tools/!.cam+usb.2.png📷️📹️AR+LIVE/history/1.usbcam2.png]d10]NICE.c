...
static int RGB_SIZE; // Initialized in main
...
static unsigned char *rgb_data = NULL; // Dynamic allocation
...
int main(int argc, char **argv) {
    ...
    printf("Webcam Renderer Controls:\n");
    printf("  p/P: Save a PNG capture\n");
