...
int main() {
    pthread_t kb_thread, game_thread, render_thread, response_thread;
 /*   
    printf("=========================================\n");
    ...
    */
    ...
    printf("Components are now running: keyboard input, game logic, display rendering, response handler\n\n");
   */ 
